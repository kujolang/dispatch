...
- [x] Linux and macOS pass the exact pinned full CI gate: SDK, routing, SQLite, policy, operational, hardening, 24 contract shards, warning-free VM/interpreter smoke, and bounded 3/3 workload. [CI run 35733957724](https://github.com/kujolang/dispatch/actions/runs/35733957724) passed both platforms at `3bb18f6`.
